 ...
 * the Models page plus the official-DeepSeek onboarding dialog, whose UI
...
export function apply(ctx: ClientContext): void {
  ...
  // The pre-release welcome notice is not registered in this deployment: it
  // blocks the application root on every fresh browser profile and carries no
  // information its operator does not already have.
