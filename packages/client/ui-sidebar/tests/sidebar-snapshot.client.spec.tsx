...
describe('sidebar shell snapshots', () => {
  it('renders the expanded column in the default locale (zh, no setLocale)', async () => {
    ...
    const slot = runtime.renderSlot('sidebar', { collapsed: false, width: 300, mobile: false, mobileOpen: false, surface: 'column' })
  ...
  it('renders the collapsed rail after the crossfade settles, in place', async () => {
    ...
    slot.update({ collapsed: true, width: 56, mobile: false, mobileOpen: false, surface: 'column' })
